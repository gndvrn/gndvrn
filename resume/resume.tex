...
\begin{center}
  ...
  {\small
    ...
    \resumelink{mailto:workgndvrn@gmail.com}{workgndvrn@gmail.com} $|$
...
{\resumelink{https://github.com/gndvrn/RESTAPI-Data-Batch-Pipeline}{\textbf{REST API Data Batch Pipeline}} $|$ Python, SQL, Airflow, dbt, ClickHouse, Docker, Superset}{}
\resumeItemListStart
...
\resumeItem{Развернул multi-service stack в Docker Compose: Airflow, ClickHouse, PostgreSQL, dbt, Superset}
\resumeItemListEnd

\resumeProjectHeading
{\resumelink{https://github.com/gndvrn/e-commerce-dwh}{\textbf{E-commerce DWH}} $|$ Python, SQL, Airflow, ClickHouse, dbt, Docker, BPMN}{}
\resumeItemListStart
...
\resumeProjectHeading
{\resumelink{https://github.com/gndvrn/docker-hadoop-spark-hive}{\textbf{Hadoop-кластер в Docker}} $|$ Hadoop, Hive, Spark, Docker, Bash}{}
\resumeItemListStart
...
\resumeProjectHeading
{\resumelink{https://github.com/gndvrn/kafka-spark-postgres-grafana-streaming}{\textbf{Streaming Data Pipeline}} $|$ Kafka, Spark, PostgreSQL, Grafana, Docker}{}
\resumeItemListStart
...
\begin{itemize}[leftmargin=0pt, label={}]
  \small{\item{
          ...
          \textbf{System design:}
          DWH architecture (Inmon, Kimball, data lake / data lakehouse / data vault), dimensional modelling, SCD, Medallion architecture, batch / streaming;
          \\

          \textbf{Инфраструктура:}
          Docker (продвинутый), Linux/Unix (средний) --- CLI, firewall, SSH, security
          \\
